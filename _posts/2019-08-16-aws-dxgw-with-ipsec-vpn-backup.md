...
* **Site-to-Site (IPSec) VPN over Internet or DX Public VIF:** The backup path via the Site-to-Site (IPSec) VPN tunnels will either leverage the Internet or a [Direct Connect Public Virtual interface](https://docs.aws.amazon.com/directconnect/latest/UserGuide/create-vif.html#create-public-vif) connection as transport mechanism.
...
* **IPv6 failover support:** AWS Site-to-Site (IPSec) VPN does [support carrying IPv6 traffic over IPv4 based IPSec tunnels](https://www.edge-cloud.net/2020/09/11/aws-ipsec-vpn-ipv6/). Therefore this failover design is also applicable for the use cases, where you want to carry private IPv6 traffic between on-premises and AWS.
