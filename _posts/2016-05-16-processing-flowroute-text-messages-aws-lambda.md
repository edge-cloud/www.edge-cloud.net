...
You can find more details on the Flowroute API documentation for receiving inbound text messages at [https://developer.flowroute.com/api/messages/v2.1/](https://developer.flowroute.com/api/messages/v2.1/).
...
This test event data is derived from the [Flowroute Messaging API documentation](https://developer.flowroute.com/api/messages/v2.1/) and is an example for what Lambda will receive from AWS API Gateway.
